...
public class Map4 extends Map{
    public static String name = "Green Map";

    private SpaceShipStyle[] spaceShipStyles = new SpaceShipStyle[]{
            SpaceShipStyle.GreenShip1,SpaceShipStyle.GreenShip2,SpaceShipStyle.GreenShip3,SpaceShipStyle.GreenShip4
    };
    ...
    public Map4(GameMain gameMain,Class<? extends Object> previousScreen){
    ...
    private void createCrystals() {
        for (int i = 0; i < 2; i++) {
            ...
            crystal.addGem(75, Gem.GemStyle.GREEN1);
            crystal.addGem(50, Gem.GemStyle.GREEN2);
            crystal.addGem(25, Gem.GemStyle.GREEN3);
            crystal.addGem(10, Gem.GemStyle.GREEN4);
            crystal.addWeapon(10, Weapon.WeaponStyle.Green_1);
            crystal.addWeapon(3, Weapon.WeaponStyle.Green_2);
    ...
    private void createPortals() {
        ...
        portals.add(new Portal(game,new Vector2(21000,22000),Base.class));
