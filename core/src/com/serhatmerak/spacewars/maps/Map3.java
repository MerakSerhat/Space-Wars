...
public class Map3 extends Map{
    public static String name = "Blue Map";

    private SpaceShipStyle[] spaceShipStyles = new SpaceShipStyle[]{
            SpaceShipStyle.BlueShip1,SpaceShipStyle.BlueShip2,SpaceShipStyle.BlueShip3,SpaceShipStyle.BlueShip4
    };
    ...
    public Map3(GameMain gameMain,Class<? extends Object> previousScreen){
    ...
    private void createCrystals() {
        for (int i = 0; i < 2; i++) {
            ...
            crystal.addGem(75, Gem.GemStyle.BLUE1);
            crystal.addGem(50, Gem.GemStyle.BLUE1);
            crystal.addGem(25, Gem.GemStyle.BLUE1);
            crystal.addGem(10, Gem.GemStyle.BLUE1);
            crystal.addWeapon(10, Weapon.WeaponStyle.Blue_1);
            crystal.addWeapon(3, Weapon.WeaponStyle.Blue_2);
