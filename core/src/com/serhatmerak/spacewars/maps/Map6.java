...
public class Map6 extends Map{
    ...
    private SpaceShipStyle[] spaceShipStyles = new SpaceShipStyle[]{
            SpaceShipStyle.BlackShip1,SpaceShipStyle.BlackShip2,SpaceShipStyle.BlackShip3,SpaceShipStyle.BlackShip4
    };
    ...
    public Map6(GameMain gameMain,Class<? extends Object> previousScreen){
    ...
    private void createCrystals() {
        for (int i = 0; i < 2; i++) {
            Crystal crystal = new Crystal(12000, new Vector2(MathUtils.random(0, 25000), MathUtils.random(0, 25000)), world);
            crystal.addCoin(new float[]{500, 1000});
            crystal.addGem(20, Gem.GemStyle.BLUE4);
            crystal.addGem(20, Gem.GemStyle.RED4);
            crystal.addGem(20, Gem.GemStyle.GREEN4);
            crystal.addGem(20, Gem.GemStyle.YELLOW4);
            crystal.addGem(10, Gem.GemStyle.BLUE5);
            crystal.addGem(10, Gem.GemStyle.RED5);
            crystal.addGem(10, Gem.GemStyle.GREEN5);
            crystal.addGem(10, Gem.GemStyle.YELLOW5);
            crystal.addWeapon(5, Weapon.WeaponStyle.Green_2);
            crystal.addWeapon(5, Weapon.WeaponStyle.Red_2);
            crystal.addWeapon(5, Weapon.WeaponStyle.Yellow_2);
            crystal.addWeapon(5, Weapon.WeaponStyle.Blue_2);
    ...
    private void createPortals() {
        ...
        portals.add(new Portal(game,new Vector2(18000,18000),Map7.class));
        portals.add(new Portal(game,new Vector2(0,0),Map5.class));
